  ...
  document.getElementById("btnn").addEventListener("click", function(){
    ...
    if(x.style.display==="none"){
      ...
      var VAD = function(options) {
        ...
        let statusIcons = {
            default: "<img src='default.gif' width='400' height='300'/>",
            //neutral: "<img src='js/neutral.gif' width='400' height='300'/>",
            happy: "<img src='happy.gif' width='400' height='300'/>",
            //sad: "<img src='js/sad.gif' width='400' height='300'/>",
            //angry: "<img src='js/angry.gif' width='400' height='300'/>",
      ...
      this.monitor = function() {
        ...
        if(start && !this.vadState) {
          ...
          console.log(this.energy);
            ...
            if(this.energy>0.0000000000001) {
                console.log("ok");
                ...
                seconds=getRndInteger(3,3); 
                console.log("seconds",seconds);  
                face.innerHTML = statusIcons["default"]
                                                    
                

                if (talking >=seconds){  //here to change the duration !!!
                    
                    face.innerHTML = statusIcons["happy"]
